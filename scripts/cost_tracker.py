"""
Hermes Guardian — 成本记账模块 (Phase 2)
...
def get_model_price(model_name):
    ...
    return MODEL_PRICES["deepseek-v4-pro"]
...
def record(model, input_tokens, output_tokens, task_type="unknown") -> dict:
    ...
    return {"recorded": True, "over_budget": over}
